    ...
    <div className="flex h-screen w-full bg-zinc-50 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 font-sans overflow-hidden">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-1">
          ...
          <Link href="/ats" className="group flex items-center gap-3 px-3 py-2.5 text-sm rounded-lg bg-zinc-200 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 transition-colors font-medium">
          ...
          >
            <span className="truncate">Load Demo JD & PDF</span>
          </div>
        </div>
